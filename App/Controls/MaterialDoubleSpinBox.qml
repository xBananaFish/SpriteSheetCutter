...
DoubleSpinBox {
    ...
    //     outlineColor: (enabled && control.hovered) ? ColorPalette.foregroundMuted : ColorPalette.border
    //     focusedOutlineColor: control.Material.accentColor
    //     controlHasActiveFocus: control.activeFocus
    //     controlHasText: true
    //     horizontalPadding: control.Material.textFieldHorizontalPadding

    //     Behavior on outlineColor { ColorAnimation { duration: 200 } }
    //     Behavior on focusedOutlineColor { ColorAnimation { duration: 200 } }
    // }
